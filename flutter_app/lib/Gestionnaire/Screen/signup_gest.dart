                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                            validator: (String value){
                              if(value.isEmpty){
                                return 'Téléphone du Restaurant ne peut pas être vide';
                              }
                              return null;
                            },
                            ...
                            decoration: InputDecoration(
                              filled: true,
                              fillColor: Colors.white,
                              hintText: 'Téléphone du Restaurant',
                              focusedBorder: OutlineInputBorder(
                                borderSide: new BorderSide(color: Colors.white),
                                borderRadius: new BorderRadius.circular(10.0),
                              ),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                            validator: (String value){
                              if(value.isEmpty){
                                return 'Adresse du restaurant ne peut pas être vide';
                              }
                              return null;
                            },
                      ...
                      Container(
                        ...
                        child: TextFormField(
                            validator: (String value){
                              if(value.isEmpty){
                                return 'Horaire du Travaille ne peut pas être vide';
                              }
                              return null;
                            },
